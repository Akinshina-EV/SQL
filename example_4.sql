...
INSERT INTO
  Analysis (an_name, an_cost, an_price, an_group)
VALUES
...
GROUP BY
  s.shopname
HAVING
  GROUP_CONCAT(c.name) NOT LIKE '%Murzik%'
...
FROM
  ...
  JOIN GroupsAn GA on A.an_id = GA.gr_id
WHERE
  DATE(O.ord_datetime) BETWEEN '2020-02-05'
